...
public sealed class SystemHealthItem
{
    ...
    public string StateText => State switch { SystemHealthState.Ok => "Ready", SystemHealthState.Warning => "Review",
                                              SystemHealthState.Error => "Needs Attention",
                                              _ => "Unknown" };

    public string Icon =>
        State switch { SystemHealthState.Ok => "●", SystemHealthState.Warning => "●", SystemHealthState.Error => "●",
                       _ => "●" };
}
