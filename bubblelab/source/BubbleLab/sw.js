const CACHE='bubble-lab-v0.4.0';
const ASSETS=['./','./index.html','./styles.css?v=0.4.0','./app.js?v=0.4.0','./manifest.webmanifest','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
