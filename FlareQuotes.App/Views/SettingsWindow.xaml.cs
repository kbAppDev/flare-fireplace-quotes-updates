    ...
    public partial class SettingsWindow : Window
    {
        ...
        private void LoadSettingsIntoForm()
        {
            try
            {
                ...
                WebsiteBox.Text = string.IsNullOrWhiteSpace(_settings.Website) ? "https://flarefireplaces.com" : _settings.Website;
                ...
                RecallQuoteHistoryLimitBox.Text = Math.Clamp(_settings.RecallQuoteHistoryLimit <= 0 ? 5 : _settings.RecallQuoteHistoryLimit, 1, 20).ToString();

                SelectEmailSendMode(_settings.EmailSendMode);

                LeadTimePresetsBox.Text = string.Join(
                    Environment.NewLine,
                    (_settings.LeadTimePresets is { Count: > 0 }
        ...
        private void SaveFormToSettings()
        {
            ...
            _settings.LeadTimePresets = LeadTimePresetsBox.Text
        ...
        private void PushSettingsIntoOwnerViewModel()
        {
            try
            {
                ...
                var onPropertyChanged = vmType.GetMethod("OnPropertyChanged", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public, null, new[] { typeof(string) }, null);
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(
                    "Settings could not be saved." + Environment.NewLine + Environment.NewLine + ex.Message,
                    "Settings Error",
                    MessageBoxButton.OK,
